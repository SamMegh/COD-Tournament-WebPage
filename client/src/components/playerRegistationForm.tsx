...
function PlayerRegistrationForm() {
  ...
  const [logoPreview, setLogoPreview] = useState<string | null>(null); // url save img src 
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-4">
                <div className="w-20 h-20 bg-gray-800/50 border-2 border-dashed border-gray-700 rounded-lg flex items-center justify-center">
                  {logoPreview ? (
                    <img src={logoPreview} className="w-20 h-20 object-cover rounded-lg" />
                  ) : (
                ...
                <div className="flex-1">
                  <input
                    ...
                    className="hidden"
                    onChange={(e) =>
                      e.target.files && setLogoPreview(URL.createObjectURL(e.target.files[0]))
                    }
                  />
                  <label
                    htmlFor="team-logo"
